...
public class CharacterStateMachine : MonoBehaviour
{
    ...
    [SerializeField] private SwordCollision _swordCollision; 
    ...
    public SwordCollision SwordCollision { get { return _swordCollision; } set { _swordCollision = value; } }
    ...
    public void ApplyModelRotation()
    {
        ...
        {
            toRotation = Quaternion.LookRotation(Vector3.zero, Vector3.up);
        }
    ...
    //{
    //    ApplyAIMRotation();
    //    Quaternion toRotation = Quaternion.LookRotation(Vector3.zero, Vector3.up);
    //    _model.rotation = Quaternion.RotateTowards(_model.rotation, toRotation, Time.deltaTime * _modelRotatingSpeed);
    //}
